...
public interface IProductTransactionRepository
{
	...
	Task<ProductTransaction?> GetProductTransactionByProductionNumberAsync(string productionNumber);
	Task<ProductTransaction?> GetProductTransactionBySalesOrderNumberAsync(string salesOrderNumber);
}